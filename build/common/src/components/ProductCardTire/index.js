...
function ProductCardTire(
	...
	const priceAvalidable = Math.round(isDiscountAvalidable
		? (
			calculardescuentos
				? (priceWithTax - ((priceWithTax * discountPercentage) / 100))
