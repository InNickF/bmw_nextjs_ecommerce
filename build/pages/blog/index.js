  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        title='Novedades'
        url={originalUrl}
        description='Encuentra aquí las últimas noticias, colecciones, videos y artículos de tu interés. Suscríbete a nuestro newsletter y recibe información de primera mano.'
        />
        <SeparatorTop />
        <Wrapper>
