...
import { colors, sortItems, genderItems, filters, colections, sizes, tireBrands } from "../../common/src/constants/products";
import { SizeFilter, GenderFilter, CollectionFilter, ColorsFilter, ScaleFilter, TypeFilter, IndexFilter, TiresFilter, RunflatFilter } from "../../common/src/components/FiltersCollapsible";
import { Breadcrumbs, CollapsibleLinks, ProductCard, Select, Wrapper, GenerateTags, View, Icon, PriceSlider, ProductCardTire } from "../../common/components";
...
import {
  NoProducts, SectionContainer, CategoriesContainer, PaginationWrapper, ProductsContainer, SelectContainer, Showing, FilterContainer, FilterButton, ProductsPage, ListProducts, ProductsPageHeader, FiltersContainerList, Separator, BtnCloseModalFilter, FilterHaderTires, ListTireBrands, SeparatorBrand,
            ...
            <Wrapper fullWrapper relative>
                  ...
                  <FilterContainer>
                    ...
                    <SelectContainer>
                      ...
                      <Select
                        ...
                        onChange={(e) => { this.multiPropsFilter({ order: e.value }); this.setState({ currentSort: e.value }) }}
              ...
              <SectionContainer>
                {motivatorsItems, getNestedCategories, categoriesPath, breadcrumbs && (
                  ...
                  >
                    {seeTires && <img style={{ maxWidth: '272px', marginBottom: '20px', width: '100%' }} src={process.env.BRAND_ID != 1 ? "/static/images/tireguide.jpg" : "/static/images/tireguideMotorrad.jpg"} />}
                    <div
